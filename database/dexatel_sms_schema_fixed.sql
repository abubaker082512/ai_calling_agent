-- Dexatel SMS Database Schema (Safe to re-run)
-- This version drops existing triggers before creating them
...
DROP TRIGGER IF EXISTS trigger_update_dexatel_sms_updated_at ON dexatel_sms;
DROP TRIGGER IF EXISTS trigger_update_dexatel_sms_campaigns_updated_at ON dexatel_sms_campaigns;
